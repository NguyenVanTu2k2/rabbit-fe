      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-slate-100 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/post" className="bg-accent-500 hover:bg-accent-600 text-white px-5 py-2.5 rounded-xl font-semibold shadow-lg shadow-accent-500/20 transition flex items-center gap-2">
              <PlusCircle size={18} />
              Đăng tin
            </Link>
            {user ? (
